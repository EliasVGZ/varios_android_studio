...
public class ListView_6_Personalizada2_DiferentesImagenes_TypedArray extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdaptadorPersonalizado_2_TypedArray adaptador = new AdaptadorPersonalizado_2_TypedArray(
                this,
                R.layout.fila_diferentes_imagenes_y_texto,       //OJO, Aqui es obtainTypedArray + array de imagenes
                getResources().getStringArray(R.array.planetas), getResources().obtainTypedArray(R.array.fotos_planetas)
